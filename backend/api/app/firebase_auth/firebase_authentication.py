...
from .firebase_exceptions import NoAuthToken, \
    InvalidAuthToken, FirebaseError, EmailVerification
...
class FirebaseAuthentication(authentication.BaseAuthentication):
    ...
    def authenticate(self, request):
        ...
        try:
            ...
            raise FirebaseError('The user proivded with auth token is not a firebase user.\
                            it has no firebase uid.')
        try:
